...
fn calculate_delta(first: &Coordinate, second: &Coordinate) -> Coordinate {
    return Coordinate {
...
pub fn calculate_distance(first: Coordinate, second: Coordinate) -> f64 {
...
mod tests {
    ...
    fn test_distance() {
        ...
        assert_eq!(distance_string, "343.77");
    }
}
